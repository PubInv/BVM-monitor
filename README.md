...
To that end we will use the [AGPL license](https://www.gnu.org/licenses/agpl-3.0.en.html) for all code, and [CERN strong reciprocal](https://ohwr.org/cern_ohl_s_v2.txt) license for hardware designs, as noted in the [Public Invention Licensing Guidelines](https://github.com/PubInv/PubInv-License-Guidelines).
